        ...
        <main class="main-content">
            ...
            <section id="dashboard" class="content-section active">
                ...
                <div class="charts-grid">
                    ...
                    <!-- 후원 방식별 현황 (도넛 차트) -->
                    <div class="chart-box">
                        <div class="chart-box-title">후원 방식별 현황</div>
    ...
    <script>
        ...
        function initializeCharts(data) {
            ...
            chartInstances.paymentMethod = new Chart(paymentMethodCtx, {
                type: 'doughnut',
                data: {
                    labels: data.paymentMethod?.labels || ['신용카드', '계좌이체', '카카오페이', '네이버페이', '토스페이'],
                    datasets: [{
                        data: data.paymentMethod?.data || [0, 0, 0, 0, 0],
                        backgroundColor: ['#3B82F6', '#10B981', '#FBBF24', '#34D399', '#60A5FA']
                    }]
                },
                options: {
                    responsive: true,
