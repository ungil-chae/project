...
/**
 * /playSF – ‘SF/판타지’ 플레이리스트 페이지를 보여주는 서블릿
 */
@WebServlet("/playSF")
public class PlaySFServlet extends HttpServlet {
    ...
    // 페이지에 표시할 책 ID 목록 (SF/판타지)
    private static final List<Integer> SF_BOOK_IDS = Arrays.asList(
    ...
    protected void doGet(HttpServletRequest req,
        ...
        List<Book> books = bookService.getBooksByIds(SF_BOOK_IDS);
        ...
        // 3. JSP 페이지로 포워딩합니다.
        req.getRequestDispatcher("/playSF.jsp").forward(req, resp);
    }
}